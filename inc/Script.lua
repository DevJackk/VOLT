...
redis:set(volt.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(volt..'lock:join:'..msg.chat_id_,true)
...
redis:del(volt..'lock:join:'..msg.chat_id_)
return "*❍ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n❍ ** تم فتح الدخول بالرابط \n*" 
end


local function ivolt(msg,MsgText)

Channel = redis:get(volt..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(volt..'joinchnl') then
...
redis:setex(volt..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(volt..'CheckExpire::'..msg.chat_id_) then 
redis:set(volt..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(volt..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(volt..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(volt..'CheckExpire::'..msg.chat_id_) then 
redis:set(volt..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(volt..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(volt..'CheckExpire::'..msg.chat_id_) then 
redis:set(volt..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(volt..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(volt..'CheckExpire::'..msg.chat_id_) then 
redis:set(volt..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(volt..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(volt..'group:name'..msg.chat_id_) or '')
redis:set(volt..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(volt..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. volt..'')
...
if not msg.Director and redis:get(volt..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(volt..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(volt..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(volt..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(volt..'admins:'..msg.chat_id_)
redis:del(volt..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(volt..'owners:'..msg.chat_id_)
redis:del(volt..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(volt..'whitelist:'..msg.chat_id_)
redis:del(volt..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(volt..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(volt..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(volt..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(volt..'linkGroup'..msg.sender_user_id_,300,true)
return '❍ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(volt..'linkGroup'..msg.chat_id_) then 
return "❍ ** اوه لا يوجد رابط .\n❍ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(volt..'group:name'..msg.chat_id_)
local GroupLink = redis:get(volt..'linkGroup'..msg.chat_id_)
...
local Text = "❍ رابـط الـمـجـمـوعه ❍ \n"..Flter_Markdown(redis:get(volt..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(volt..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(volt..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "❍ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(volt..':Filter_Word:'..msg.chat_id_)
...
redis:del(volt..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(volt..'welcome:msg'..msg.chat_id_) then 
return "❍ ** اوه هنالك خطأ .\n❍ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(volt..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(volt..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "❍ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(volt..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(volt..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "❍ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(volt..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(volt..'banned:'..msg.chat_id_)
if #list == 0 then return "*❍ لا يوجد مستخدمين محظورين  *" end
message = '❍ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(volt..'banned:'..msg.chat_id_)
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."   \n❍  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(volt..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "❍ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(volt..'is_silent_users:'..msg.chat_id_)
...
redis:del(volt..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "❍ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(volt..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(volt..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "❍ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(volt..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(volt..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(volt..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(volt..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(volt..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(volt..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(volt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(volt..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(volt..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(volt.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(volt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(volt..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(volt..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(volt..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(volt..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(volt..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(volt..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(volt..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(volt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "❍ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '❍ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "❍ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(volt..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "❍ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(volt..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(volt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(volt..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(volt..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(volt..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(volt..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(volt..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(volt..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(volt..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(volt..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(volt..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(volt..'welcome:msg'..msg.chat_id_))
else 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."  \n❍ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(volt..'group:ids')
...
local pv = redis:smembers(volt..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(volt..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(volt..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[❍ اهلا انا بوت]]..redis:get(volt..':NameBot:')..[[ .
...
redis:setex(volt..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '❍ حسننا عزيزي .\n❍ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(volt..':addnumberusers',MsgText[2]) 
return '❍ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'❍ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(volt..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
return '❍ ** عدد المجموعات المفعلة » `'..redis:scard(volt..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
return '❍ **عدد المشتركين في البوت : `'..redis:scard(volt..'users')..'` \n'
end
...
if not msg.SudoUser then return "❍ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(volt..'group:ids',MsgText[2]) then
local name_gp = redis:get(volt..'group:name'..MsgText[2])
...
return redis:get(volt..":TEXT_SUDO") or '❍ لا توجد كليشه المطور .\n❍ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"❍ **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(volt..'lock_brod') then return "❍ ** الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(volt..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "❍ حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"❍ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(volt..'lock_brod') then 
return "❍ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(volt..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(volt..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(volt..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(volt..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(volt..'welcom:witting'..msg.sender_user_id_,
volt..'rulse:witting'..msg.sender_user_id_,
volt..'rulse:witting'..msg.sender_user_id_,
volt..'name:witting'..msg.sender_user_id_,
volt..'about:witting'..msg.sender_user_id_,
volt..'fwd:all'..msg.sender_user_id_,
volt..'fwd:pv'..msg.sender_user_id_,
volt..'fwd:groups'..msg.sender_user_id_,
volt..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
volt..'namebot:witting'..msg.sender_user_id_,
volt..'addrd_all:'..msg.sender_user_id_,
volt..'delrd:'..msg.sender_user_id_,
volt..'addrd:'..msg.sender_user_id_,
volt..'delrdall:'..msg.sender_user_id_,
volt..'text_sudo:witting'..msg.sender_user_id_,
volt..'addrd:'..msg.chat_id_..msg.sender_user_id_,
volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/jack1eljoker1/voltfiles/main/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(volt..":VERSION",GetVerison)
return false
else
...
return '❍ اصدار سورس فولت : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'❍ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فولت يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SO_VOL"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : فولت](https://t.me/SO_VOL)' ,nil,inline,msg.id_)
return false
end
...
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/uu_1_p"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/uu_1_p)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '❍ الاحصائيات . \n\n❍ **عدد المجموعات المفعله : '..redis:scard(volt..'group:ids')..'\n❍ **عدد المشتركين في البوت : '..redis:scard(volt..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(volt..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(volt..'replay:'..msg.chat_id_)
local photo 	= redis:exists(volt..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(volt..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(volt..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(volt..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(volt..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(volt..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(volt..'replay:'..msg.chat_id_,volt..'replay_photo:group:'..msg.chat_id_,volt..'replay_voice:group:'..msg.chat_id_,
volt..'replay_animation:group:'..msg.chat_id_,volt..'replay_audio:group:'..msg.chat_id_,volt..'replay_sticker:group:'..msg.chat_id_,volt..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(volt..'replay:all')
local photo 	= redis:exists(volt..'replay_photo:group:')
local voice 	= redis:exists(volt..'replay_voice:group:')
local imation 	= redis:exists(volt..'replay_animation:group:')
local audio 	= redis:exists(volt..'replay_audio:group:')
local sticker 	= redis:exists(volt..'replay_sticker:group:')
local video 	= redis:exists(volt..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(volt..'replay:all',volt..'replay_photo:group:',volt..'replay_voice:group:',volt..'replay_animation:group:',volt..'replay_audio:group:',volt..'replay_sticker:group:',volt..'replay_video:group:')
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(volt..'delrdall:'..msg.sender_user_id_,true) 
return "❍ حسننا عزيزي  .\n❍ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(volt..'delrd:'..msg.sender_user_id_,true)
return "❍ حسننا عزيزي  .\n❍ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "❍ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(volt..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(volt..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(volt..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(volt..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(volt..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(volt..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(volt..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(volt..'replay:all')
local photo 	= redis:hkeys(volt..'replay_photo:group:')
local voice 	= redis:hkeys(volt..'replay_voice:group:')
local imation 	= redis:hkeys(volt..'replay_animation:group:')
local audio 	= redis:hkeys(volt..'replay_audio:group:')
local sticker 	= redis:hkeys(volt..'replay_sticker:group:')
local video 	= redis:hkeys(volt..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '❍ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "❍ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(volt..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "❍ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(volt..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❍ " end
if not redis:get(volt..'lave_me'..msg.chat_id_) then 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** المغادره بالتاكيد تم تفعيلها\n❍" 
else 
redis:del(volt..'lave_me'..msg.chat_id_) 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** تم تفعيل المغادره \n❍" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "❍ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n❍ " end
if redis:get(volt..'lave_me'..msg.chat_id_) then 
return "❍ **أهلا عزيزي "..msg.TheRankCmd.."\n❍ ** المغادره من قبل البوت بالتأكيد معطله\n❍" 
else
redis:set(volt..'lave_me'..msg.chat_id_,true)  
...
return [[
 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 𓆩𝙰𝙷𝙼𝙴𝙳 𝙿𝙰𝙽𝙳𝙰𓆪⁦.](t.me/uu_1_p)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ـــ❍>> [˹ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐕𝐨𝐥𝐭](t.me/SO_VOL)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
end
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(volt..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"❍ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(volt..":UserNameChaneel")
if UserChaneel then
...
if redis:get(volt..'welc'..msg.chat_id_) == 'on' then
...
local hash = volt..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
VOLT = msg.text 
if VOLT == 'رفع مشرف كامل' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(volt,diamond)
...
if VOLT == 'رفع مشرف' and msg.reply_to_message_id_ ~= 0 then
...
if VOLT == 'تنزيل مشرف' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function remadmins(volt,diamond)
...
mmd = redis:get(volt..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(volt..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(volt..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'❍ اهلا عزيزي \n❍ تم تثبيت الامر الجديد\n❍')
redis:del(volt..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if VOLT:match('تغير امر (.*)') then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = VOLT:match('تغير امر (.*)') 
redis:setex(volt..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'❍ اهلا بك عزيزي\n❍ الامر الي تريد تغيره الي  "'..cmd..'" \n❍ ارسله الان\n')
end

if VOLT and (VOLT:match('^delcmd (.*)') or VOLT:match('^مسح امر (.*)')) then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = VOLT:match('^delcmd (.*)') or VOLT:match('^مسح امر (.*)')
redis:hdel(volt..'CmD:'..msg.chat_id_,cmd)
redis:srem(volt..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"❍ اهلا عزيزي\nالامر >"..cmd.."\n❍ تم مسحه من قائمه الاوامر\n")
end
if VOLT == 'مسح قائمه الاوامر' or VOLT == 'مسح قائمه الاوامر' then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(volt..'CmD:'..msg.chat_id_)
redis:del(volt..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"❍ اهلا عزيزي تم مسح قائمه الاوامر")
end
if VOLT == "قائمه الاوامر" then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(volt..'CmDlist:'..msg.chat_id_)
local t = '❍ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(volt..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
if VOLT == 'welcome on' or VOLT == 'تفعيل الترحيب' then
if redis:get(volt..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الترحيب سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الترحيب')
redis:set(volt..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(volt..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(volt..'welc'..msg.chat_id_,'off')
redis:del(volt..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if VOLT == 'welcome on' or VOLT == 'تفعيل الفولت تيم' then
if redis:get(volt..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفولت تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفولت تيم')
redis:set(volt..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم الفولت' then
if redis:get(volt..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم الفولت سابقا')
redis:set(volt..'welc'..msg.chat_id_,'off')
redis:del(volt..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الفولت الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(volt..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(volt..'setchs') and msg.SudoUser then
redis:set(volt..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(volt..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(volt..'setchs',120,true)
end
...
function tophoto(kara,volt)   
if volt.content_.ID == "MessageSticker" then        
local bd = volt.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(volt..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(volt..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*❍ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(volt..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس فولت\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"مطور السورس","المبرمج جاك"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل الفولت تيم","تعطيل تيم الفولت"},
...
redis:sadd(volt..'users',msg.sender_user_id_)
if redis:get(volt..'lock_service') then 
text = [[❍ أهلاً انا بوت   []]..redis:get(volt..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(volt.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(volt..'lock_twasel') then
...
redis:setex(volt.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(volt..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(volt..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(volt..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n❍ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(volt..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه صوره للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(volt..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه بصمه صوت للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(volt..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه متحركه للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(volt..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه فيديو للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(volt..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه للصوت للرد بنجاح\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(volt..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(volt..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(volt..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(volt..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ❍ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(volt..'replay_photo:group:',klma,photo_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه صوره للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(volt..'replay_voice:group:',klma,voice_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه بصمه صوت للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(volt..'replay_animation:group:',klma,animation_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه متحركه للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(volt..'replay_video:group:',klma,video_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه فيديو للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(volt..'replay_audio:group:',klma,audio_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم اضافه للصوت للرد العام\n❍ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(volt..'replay_sticker:group:',klma,sticker_id)
redis:del(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(volt..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(volt..":ForceSub:"..msg.sender_user_id_)
...
redis:set(volt..":UserNameChaneel",msg.text)
...
if redis:get(volt..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(volt..'namebot:witting'..msg.sender_user_id_)
redis:set(volt..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"❍ تم تغير اسم البوت  .\n❍ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(volt..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(volt..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(volt..'replay_photo:group:',msg.text)
redis:hdel(volt..'replay_voice:group:',msg.text)
redis:hdel(volt..'replay_animation:group:',msg.text)
redis:hdel(volt..'replay_audio:group:',msg.text)
redis:hdel(volt..'replay_sticker:group:',msg.text)
redis:hdel(volt..'replay_video:group:',msg.text)
redis:setex(volt..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ جيد , يمكنك الان ارسال جوا ب الردالعام \n❍ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(volt..'delrdall:'..msg.sender_user_id_) then
redis:del(volt..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(volt..'replay:all',msg.text)
local photo =redis:hget(volt..'replay_photo:group:',msg.text)
local voice = redis:hget(volt..'replay_voice:group:',msg.text)
local animation = redis:hget(volt..'replay_animation:group:',msg.text)
local audio = redis:hget(volt..'replay_audio:group:',msg.text)
local sticker = redis:hget(volt..'replay_sticker:group:',msg.text)
local video = redis:hget(volt..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'❍ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(volt..'replay:all',msg.text)
redis:hdel(volt..'replay_photo:group:',msg.text)
redis:hdel(volt..'replay_voice:group:',msg.text)
redis:hdel(volt..'replay_audio:group:',msg.text)
redis:hdel(volt..'replay_animation:group:',msg.text)
...
if redis:get(volt..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(volt..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(volt..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "❍ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(volt..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(volt..'welcom:witting'..msg.sender_user_id_) 
redis:set(volt..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(volt..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(volt..'rulse:witting'..msg.sender_user_id_) 
redis:set(volt..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'❍ ** مرحبآ عزيزي\n❍ تم حفظ القوانين بنجاح .\n❍ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(volt..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(volt..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(volt..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(volt..'linkGroup'..msg.sender_user_id_,link) 
redis:set(volt..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'❍ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(volt..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(volt..'about:witting'..msg.sender_user_id_) 
...
if redis:get(volt..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(volt..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(volt..'users')  
local groups = redis:smembers(volt..'group:ids')
...
if redis:get(volt..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(volt..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(volt..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(volt..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'❍ **عدد المجموعات { *'..#groups..'*  } ⊰•\n❍ **تـم الاذاعه بالتثبيت بنجاح ♥')
end

if redis:get(volt..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(volt..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(volt..'users')
if #pv >= 300 then
...
if redis:get(volt..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(volt..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(volt..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'❍ اهلا عزيزي المطور \n❍ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.adduser and msg.adduser == our_id and redis:get(volt..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(volt..':WELCOME_BOT'),[[❍أهلاً انا بوت ]]..redis:get(volt..':NameBot:')..[[
❍ أختصاصي حماية‌‏ المجموعات
❍ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(volt..'fwd:'..msg.sender_user_id_) then
redis:del(volt..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(volt..'users')
local groups = redis:smembers(volt..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(volt..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(volt..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(volt..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'❍ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(volt..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(volt..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(volt..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(volt..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(volt..'replay:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(volt..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(volt..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"❍ جيد , يمكنك الان ارسال جواب الرد \n❍ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(volt..'delrd:'..msg.sender_user_id_) then
redis:del(volt..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(volt..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(volt..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(volt..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(volt..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(volt..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(volt..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(volt..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'❍ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(volt..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(volt..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(volt..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(volt..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(volt..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(volt..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(volt..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(volt..'welcome:msg'..msg.chat_id_) or "❍ اهلاً عزيزي {الاسم}\n❍ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(volt..'rulse:msg'..msg.chat_id_) or "❍ مرحباً عزيري القوانين كلاتي .\n❍ ممنوع نشر الروابط\n❍ ممنوع التكلم او نشر صور اباحيه\n❍ ممنوع  اعاده توجيه\n❍ ممنوع التكلم بالسياسة\n❍ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(volt..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(volt..'welcome:msg'..msg.chat_id_) or "❍ اهلن بك عزيزي {الاسم}\n❍ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(volt..'rulse:msg'..msg.chat_id_) or "❍ مرحباً عزيري القوانين كلاتي .\n❍ ممنوع نشر الروابط\n❍ ممنوع التكلم او نشر صور اباحيه\n❍ ممنوع  اعاده توجيه\n❍ ممنوع التكلم بالسياسة\n❍ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(volt..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(volt..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(volt..'welcome:get'..msg.chat_id_)
end
redis:setex(volt..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(volt..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(volt..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_volt = (redis:get(volt..'num_msg_volt'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_volt) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(volt..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"❍ العضو » "..USERNAME.."\n❍ قمـت بتكرار اكثر مـن "..NUM_MSG_volt.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(volt..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(volt..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(volt..'lock_woring'..msg.chat_id_) and not redis:get(volt..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(volt..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(volt..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(volt..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'❍ ** لا يمكنني مسح الرساله المخالفه .\n❍ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(volt..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(volt..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(volt..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(volt..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(volt..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(volt..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(volt..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(volt..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(volt..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(volt..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(volt..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(volt..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(volt..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(volt..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(volt..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(volt..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(volt..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(volt..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(volt..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(volt..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(volt..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(volt..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(volt..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(volt..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(volt..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(volt..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(volt..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(volt..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(volt..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(volt..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(volt..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(volt..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(volt..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(volt..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(volt..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "باندا" or Text== "احمد" or Text== "احمد باندا" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس فولت ](https://t.me/uu_1_p)")
...
elseif Text== "رفع الفولت"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع فولت بنجاح \n❍ اديلو فولت\n")
elseif Text== "تنزيل الفولت"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ لقد تم رفع فولت بنجاح \n❍ اديلو فولت\n")
...
elseif Text== "رفع فولت"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ تم رفع الواد ضمن الزنوج بنجاح\n❍الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل فولت"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ تم ازاله الواد بعيدا عن الزنوج بنجاح \n❍الان تم ازلته من قائمه الزنوج\n")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس فولت/n")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/SO_VOL) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/SO_VOL)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/SO_VOL)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/SO_VOL)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/SO_VOL)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SO_VOL) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/SO_VOL)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SO_VOL)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SO_VOL)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SO_VOL)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..volt..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(volt..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(volt..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(volt..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(volt..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(volt..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(volt..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(volt..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(volt..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(volt..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'❍ انتهى الاشتراك في احد المجموعات .\n❍ المجموعه : '..FlterName(redis:get(volt..'group:name'..msg.chat_id_))..'.\n❍ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'❍ انتهى الاشتراك البوت.\n❍ سوف اغادر المجموعه فرصه سعيده .\n❍ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(volt..'ExpireDate:'..msg.chat_id_) / 86400)
