...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(volt..":NameBot:")
...
var =  'المبرمج جاك'
elseif  UserID == 1815672157 then
var =  'مطور السورس'
elseif redis:sismember(volt..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(volt..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(volt..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(volt..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(volt..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(volt..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(volt..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(volt..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(volt..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(volt..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(volt..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(volt..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(volt..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(volt..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(volt..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(volt..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(volt..'username:'..v)
local count = redis:scard(volt..'mtwr_count'..v)
...
local monsha = redis:smembers(volt..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(volt..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(volt..'admins:'..msg.chat_id_)
...
local list = redis:smembers(volt..'whitelist:'..msg.chat_id_)
...
if redis:sismember(volt..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(volt..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(volt..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(volt..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(volt..'gban_users')
...
local list = redis:smembers(volt..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(volt..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(volt..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(volt..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(volt..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(volt..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(volt..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(volt..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(volt..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(volt..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(volt..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px volt;}</style>
<body>
...
redis:del(
volt..'group:add'..id_group,
volt..'lock_link'..id_group, 
volt..'lock_id'..id_group,
volt..'lock_spam'..id_group, 
volt..'lock_webpage'..id_group,
volt..'lock_markdown'..id_group,
volt..'lock_flood'..id_group,
volt..'lock_bots'..id_group,
volt..'mute_forward'..id_group,
volt..'mute_contact'..id_group,
volt..'mute_location'..id_group,
volt..'mute_document'..id_group,
volt..'mute_keyboard'..id_group,
volt..'mute_game'..id_group,
volt..'mute_inline'..id_group,
volt..'lock_username'..id_group,
volt..'num_msg_volt'..id_group,
volt..'replay'..id_group
)
redis:srem(volt..'group:ids',id_group)
end
...
redis:hset(volt..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(volt..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(volt..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(volt..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(volt..':addnumberusers') or 0)
...
local lock_service = redis:get(volt..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(volt..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(volt..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
volt..'group:add'..msg.chat_id_,true,
volt..'lock_link'..msg.chat_id_,true, 
volt..'lock_id'..msg.chat_id_,true,
volt..'lock_spam'..msg.chat_id_,true,
volt..'lock_webpage'..msg.chat_id_,true,
volt..'lock_markdown'..msg.chat_id_,true,
volt..'lock_flood'..msg.chat_id_,true,
volt..'lock_bots'..msg.chat_id_,true,
volt..'mute_forward'..msg.chat_id_,true,
volt..'mute_contact'..msg.chat_id_,true,
volt..'mute_location'..msg.chat_id_,true,
volt..'mute_document'..msg.chat_id_,true,
volt..'mute_keyboard'..msg.chat_id_,true,
volt..'mute_game'..msg.chat_id_,true,
volt..'mute_inline'..msg.chat_id_,true,
volt..'lock_username'..msg.chat_id_,true,
volt..'num_msg_volt'..msg.chat_id_,5, 
volt..'replay'..msg.chat_id_,true
)

redis:sadd(volt..'group:ids',msg.chat_id_) 
redis:sadd(volt..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(volt..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(volt..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(volt..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(volt..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID,'username',Resolv)
redis:sadd(volt..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(volt..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(volt..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(volt..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID,'username',Resolv)
redis:sadd(volt..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(volt..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(volt..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(volt..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(volt..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(volt..'whitelist:'..ChatID,UserID)
...
if redis:sismember(volt..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..'owners:'..ChatID,UserID)
...
if redis:sismember(volt..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(volt..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(volt..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(volt..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(volt..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(volt..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(volt..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(volt..'banned:'..ChatID,UserID)
...
if redis:sismember(volt..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(volt..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(volt..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(volt..'username:'..UserID, 'username',Resolv)
redis:sadd(volt..'gban_users',UserID)
...
redis:srem(volt..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(volt..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(volt..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(volt..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(volt..'username:'..UserID, 'username', UserName)
redis:sadd(volt..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(volt..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(volt..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(volt..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(volt..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(volt..'username:'..UserID, 'username', Resolv)
redis:sadd(volt..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(volt..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(volt..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(volt..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(volt..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(volt..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(volt..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(volt..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(volt..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(volt..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(volt..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(volt..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(volt..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(volt..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(volt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(volt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(volt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(volt..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(volt..'num_msg_volt'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(volt..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(volt..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(volt..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(volt..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(volt..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(volt..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(volt..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(volt..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(volt..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(volt..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(volt..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(volt..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(volt..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(volt..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(volt..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(volt..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(volt..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(volt..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(volt..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(volt..'num_msg_volt'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(volt..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(volt..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(volt..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(volt..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(volt..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
